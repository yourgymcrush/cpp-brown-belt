...
public:
  explicit Unit(geo2d::Point position) : m_position(position) {}

  geo2d::Point GetPosition() const {return m_position;}
...
public:
  explicit Building(geo2d::Rectangle geometry) : m_position(geometry) {}

  geo2d::Rectangle GetPosition() const {return m_position;}
...
public:
  explicit Tower(geo2d::Circle geometry) : m_position(geometry) {}

  geo2d::Circle GetPosition() const {return m_position;}
...
public:
  explicit Fence(geo2d::Segment geometry) : m_position(geometry) {}

  geo2d::Segment GetPosition() const {return m_position;}
